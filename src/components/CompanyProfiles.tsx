...
const companies: Company[] = [
  {
    ...
    founded: "2019",
    description: "IIT Madras initiative focused on democratizing AI for Indian languages and creating open-source language models and TTS systems.",
    models: ["IndicBERT", "IndicBART", "Airavata", "RomanSetu", "Indic-TTS"],
    modelTypes: ["LLM", "TTS"],
    achievements: [
  ...
  },
  {
    ...
    founded: "2023",
    description: "AI startup building full-stack language AI for India with focus on practical applications, enterprise solutions, and advanced TTS capabilities.",
    models: ["OpenHathi", "Sarvam-2B", "Sarvam-1", "Sarvam-m", "Sovereign LLMs", "Bulbul-v1", "Bulbul-v2"],
    modelTypes: ["LLM", "TTS"],
    achievements: [
  ...
  },
  {
    ...
    location: "Pune, India",
    founded: "1988",
    description: "Government research organization developing comprehensive Hindi TTS systems with multiple architectures.",
  ...
  },
  {
    ...
    location: "Chennai, India",
    founded: "2020",
    description: "Multi-institutional consortium developing TTS systems for 22 Indian languages with focus on accessibility.",
  ...
  },
  {
    ...
    location: "Bengaluru, India",
    founded: "1909",
    description: "Premier research institute developing SYSPIN project for large corpora and TTS models.",
  ...
  },
  {
    ...
    location: "Mumbai, India",
    founded: "2020",
    description: "Commercial startup providing TTS and speech-to-text services with focus on accessibility.",
  ...
  },
  {
    ...
    location: "New Delhi, India",
    founded: "2023",
    description: "Government AI initiative providing TTS models with focus on accessibility and speech synthesis.",
    models: ["AIKosh TTS"],
    modelTypes: ["TTS"],
    achievements: [
      "Multiple Indian languages",
...
export const CompanyProfiles = ({ searchTerm }: CompanyProfilesProps) => {
  ...
  const getModelTypeColor = (modelType: string) => {
    switch (modelType) {
      case "LLM": return "bg-blue-50 text-blue-700";
      case "TTS": return "bg-purple-50 text-purple-700";
    ...
    <div className="space-y-6">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600 max-w-2xl mx-auto">
          Meet the pioneering institutions and companies building LLMs and TTS models for India's future
        </p>
      </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex flex-wrap gap-1">
                    {company.modelTypes.map((modelType, index) => (
                      <Badge key={index} className={getModelTypeColor(modelType)}>
                        {modelType === "LLM" ? "Language Models" : "Text-to-Speech"}
                      </Badge>
                    ))}
                  </div>
                </div>
